...
class Oracle(Pyodbc):
    ...
    custom_evars = ["oracle_conn_default"]
    ...
    # These are the custom options for your integration    
    myopts = {}
    myopts['oracle_max_rows'] = [1000, 'Max number of rows to return, will potentially add this to queries']
    myopts['oracle_conn_default'] = ["default", 'Default instance name for connections']
...
# def customHelp - In pyodbc
    ...
    @line_cell_magic
    def oracle(self, line, cell=None):
        if cell is None:
            line = line.replace("\r", "")
